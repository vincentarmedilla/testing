...
class ReservationItemView implements IReservedItemView
{
    ...
    )
    {
        ...
        //get client name
        $get_reservation = $obj->getReservationInstanceSeries($referenceNumber);
        ...
        $this->client_on_site = $get_reservation['client_on_site'];
        $this->project_no = $get_reservation['project'];
    ...
    {
        //echo $row[ColumnNames::ATTRIBUTE_LIST];exit();
